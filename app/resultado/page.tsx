          ...
          {showOverlay && (
            ...
            >
              <div className="text-center max-w-md mx-auto p-6">
                ...
                {/* Ícone de bloqueio */}
                <Lock className="text-red-400 mx-auto mb-6" size={80} />
                ...
                <p className="text-red-400 font-bold text-lg mb-6">
                  {getPersonalizedPronoun()} está con {getPersonalizedOther()} HOY... o tú actúas AHORA
                </p>

                {/* Cronômetros */}
                <div className="space-y-4 mb-6">
                  <div className="bg-red-900/50 rounded-lg p-4 border border-red-500">
                    <p className="text-red-300 font-bold mb-2">⏰ PÁGINA SAI DO AR EM:</p>
                  ...
                  <div className="bg-orange-900/50 rounded-lg p-3 border border-orange-500">
                    <p className="text-orange-300 font-bold">
                      🔥 Solo {accessCount} accesos restantes hoy
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-yellow-600 rounded-lg p-4 mb-6">
                  ...
                  <p className="text-black font-semibold mb-3">
                    Mira el video abajo y espera
                  </p>
                  <div className="text-black font-black text-3xl">
                    {Math.floor(unlockTimer / 60)}:{(unlockTimer % 60).toString().padStart(2, '0')}
                  </div>
                  <p className="text-black font-semibold mt-2">
                    {unlockTimer > 0 ? "Mantén esta página abierta" : "¡Desbloqueando...!"}
                  </p>
                </div>

                {/* Aviso final */}
                <p className="text-gray-300 text-sm">
                  💔 Si cierras esta página, {getPersonalizedPronoun()} puede estar en brazos de {getPersonalizedOther()} HOY
                </p>
              </div>
            </motion.div>
          )}
